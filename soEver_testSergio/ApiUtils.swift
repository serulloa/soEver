...
//    let BASE_URL_APPLE = "https://rss.itunes.apple.com/api/v1/%@/%@/%@/%@/%@/%@.json"
    ...
    let BASE_URL_APPLE_2018_OBF: [UInt8] = [56, 38, 33, 53, 49, 123, 30, 127, 32, 38, 54, 108, 40,
                                            69, 37, 60, 48, 54, 108, 32, 65, 32, 62, 48, 107, 33,
                                            46, 92, 127, 51, 37, 44, 109, 55, 0, 127, 119, 21, 106,
                                            103, 1, 30, 117, 18, 122, 36, 46, 45, 30, 117, 18, 122,
                                            32, 58, 49, 93, 57, 49, 60, 49, 108, 43, 66, 63, 60]
}
